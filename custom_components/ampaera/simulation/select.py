...
async def async_setup_entry(
    ...
    # Note: Household simulation runs internally but is NOT exposed as a HA device.
    # Presence mode and building type can be configured via options flow if needed.
